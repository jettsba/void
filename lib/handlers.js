...
export function handleSignal(ws, data) {
     ...
     *
     * Лимит длины SDP — 32 КБ. Минимальный mesh-handshake укладывается в
     ...
     * в v0.9.10-0.9.12). 32 КБ даёт запас на 5-8 циклов; и одновременно
     * остаётся под WS max payload (64 КБ) с JSON-overhead'ом запасом.
     */
