 ...
 *
 * Общая точка для двух путей: обычного `create-room` и авто-подъёма
 * зарезервированной комнаты при входе (см. handleJoinRoom). Держим одной
 * функцией, чтобы TTL-таймер и счётчики не разъехались между ними.
 */
